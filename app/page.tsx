    ...
    <main>
      ...
      <section id="sec-01" className="px-8 md:px-16 py-20 md:py-28">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 md:gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <h1 className="font-sans text-2xl md:text-3xl lg:text-4xl font-bold leading-snug mb-8 max-w-2xl">
      ...
      <section id="sec-03" className="border-t-2 border-ink px-8 md:px-16 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-sans text-2xl md:text-3xl font-bold leading-snug mb-12 max-w-2xl">
      ...
      <section id="sec-05" className="bg-ink text-paper">
        <div className="px-8 md:px-16 py-20">
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="font-sans text-2xl md:text-3xl font-bold leading-snug mb-3 text-paper">
      ...
      <section id="sec-06" className="border-t-2 border-ink px-8 md:px-16 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-sans text-2xl md:text-3xl font-bold leading-snug mb-12 max-w-xl">
      ...
      <section id="sec-07" className="bg-highlight border-t-2 border-ink px-8 md:px-16 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-sans text-3xl md:text-5xl font-black leading-tight mb-4">
            Your next hire{' '}
